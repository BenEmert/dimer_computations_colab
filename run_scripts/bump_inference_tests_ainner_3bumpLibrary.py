...
## Settings for TuneK
parser1.add_argument('--base_dir', default='../results/bumps_3library/a-inner_w-outer/', type=str) # base directory for output
...
def opt_wrapper(opt_setts, n_rounds=1, bump_center=0.5, bump_width=2, **kwargs):
    ...
    F = bump_targets(bump_centers=[0.2, 0.5, 0.8], bump_width=2, n_input_samples=FOO.n_input_samples)
