...
def run_main(sett):
    ...
    tune_dict = {k.split('_')[0]: sett[k] for k in tune_names}

    n_iters = sett_K['maxiter']*sett_K['popsize']*tune_dict['maxiter']*tune_dict['popsize']
    if n_iters <= MAX_ITERS:
        opt_wrapper(sett_K, tune_dict=tune_dict, **sett)
